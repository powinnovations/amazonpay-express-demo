class HomeController < ApplicationController
  ...
  def signature
    ...
    client = ExpressAmazonPayments::Client.new(access_key, secret_key, seller_id, amount, return_url, lwa_client_id, currency_code: currency_code, seller_note: seller_note, seller_order_id: seller_order_id, shipping_address_required: shipping_address_required, payment_action: payment_action)
